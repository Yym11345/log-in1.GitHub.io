...
-- 创建基因信息表
CREATE TABLE IF NOT EXISTS geness (
...
-- 创建索引以提高查询性能
CREATE INDEX IF NOT EXISTS idx_geness_entry ON geness(entry);
CREATE INDEX IF NOT EXISTS idx_geness_entry_name ON geness(entry_name);
CREATE INDEX IF NOT EXISTS idx_geness_protein_names ON geness(protein_names);
CREATE INDEX IF NOT EXISTS idx_geness_gene_names ON geness(gene_names);
